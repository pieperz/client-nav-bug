...
const MobileNavigationNoHeadless = ({
  open,
  setOpen,
}: {
  open: boolean;
  ...
  return (
    ...
    //     >
          <div className={`relative flex flex-col w-full max-w-[17.5rem] 2xs:max-w-[19rem] xs:max-w-[24rem]`} style={{display: `${open ? "block": "none"}`}}>
...
export default MobileNavigationNoHeadless;
